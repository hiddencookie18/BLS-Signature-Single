...
print("Coefficients from the first pairing")
print("************************")


print(is_on_curve(signature,b))
print(is_on_curve(HM,b))
print(is_on_curve(pubkey,b2))
print(final_exponentiate(pairing(G2, signature,final_exponentiate=False,) * pairing(neg(pubkey), HM,final_exponentiate=False,)))
print(pairing(G2, signature,final_exponentiate=False,))
print(pairing(pubkey, HM,final_exponentiate=False,))